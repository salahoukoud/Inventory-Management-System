 ...
 * @author Pahansith
 */
public class StockReportForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Stock Item List" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            try {
                ...
                try {
                    ...
                    Logger.getLogger(StockReportForm.class.getName()).log(Level.SEVERE, null, ex);
                }
